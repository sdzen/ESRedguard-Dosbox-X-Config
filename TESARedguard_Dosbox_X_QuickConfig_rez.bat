...
powershell -Command "(New-Object Net.WebClient).DownloadFile('https://github.com/sdzen/ESRedguard-Dosbox-X-Config/releases/download/1.1test/Dosbox_X_ESR.zip', 'DOSBox-X-ESR.zip')"
...
:DOS
powershell -Command "(gc DOSBOX\dgVoodoo.conf) -replace 'unforced', '640x480@60' | Out-File -encoding ASCII DOSBOX\dgVoodoo.conf"
goto commonexit
:BASE
powershell -Command "(gc DOSBOX\dgVoodoo.conf) -replace 'unforced', '1024x768@60' | Out-File -encoding ASCII DOSBOX\dgVoodoo.conf"
goto commonexit
:108043
powershell -Command "(gc DOSBOX\dgVoodoo.conf) -replace 'unforced', '1440x1080@60' | Out-File -encoding ASCII DOSBOX\dgVoodoo.conf"
goto commonexit
:1080169
powershell -Command "(gc DOSBOX\dgVoodoo.conf) -replace 'unforced', '1920x1080@60' | Out-File -encoding ASCII DOSBOX\dgVoodoo.conf"
powershell -Command "(gc DOSBOX\dgVoodoo.conf) -replace 'FullscreenAttributes', ';FullscreenAttributes' | Out-File -encoding ASCII DOSBOX\dgVoodoo.conf"
goto commonexit
:144043
powershell -Command "(gc DOSBOX\dgVoodoo.conf) -replace 'unforced', '1920x1440@60' | Out-File -encoding ASCII DOSBOX\dgVoodoo.conf"
goto commonexit
:1440169
powershell -Command "(gc DOSBOX\dgVoodoo.conf) -replace 'unforced', '2560x1440@60' | Out-File -encoding ASCII DOSBOX\dgVoodoo.conf"
powershell -Command "(gc DOSBOX\dgVoodoo.conf) -replace 'FullscreenAttributes', ';FullscreenAttributes' | Out-File -encoding ASCII DOSBOX\dgVoodoo.conf"
goto commonexit
:4K43
powershell -Command "(gc DOSBOX\dgVoodoo.conf) -replace 'unforced', '2880x2160@60' | Out-File -encoding ASCII DOSBOX\dgVoodoo.conf"
goto commonexit
:4K169
powershell -Command "(gc DOSBOX\dgVoodoo.conf) -replace 'unforced', '3840x2160@60' | Out-File -encoding ASCII DOSBOX\dgVoodoo.conf"
powershell -Command "(gc DOSBOX\dgVoodoo.conf) -replace 'FullscreenAttributes', ';FullscreenAttributes' | Out-File -encoding ASCII DOSBOX\dgVoodoo.conf"
goto commonexit
